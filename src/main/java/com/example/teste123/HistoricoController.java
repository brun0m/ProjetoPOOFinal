...
public class HistoricoController {
    ...
    public void initialize(){
        ...
        String mostrarDados = "SELECT NomeMedico, Atendimento, Estrelas, Data from new_agendamento WHERE UsuarioPaciente='" +
                HelloApplication.Loginsusuario.get(HelloApplication.Loginsusuario.size()-1).getUsuario() + "' and" +
                " Encerrou='true'";
        setUsuarioMenu(HelloApplication.Loginsusuario.get(HelloApplication.Loginsusuario.size()-1).getUsuario());
            try{
                ...
                while(resultadoMedicos.next()){
                    ...
                    String Avaliacao = resultadoMedicos.getString("Atendimento");
                ...
                ComentarioTabela.setCellValueFactory(new PropertyValueFactory<HistoricoModelo,String>("Comentario"));
                //
