...
public class UrologiaController {
    ...
    public void initialize(){
        ...
        try{
            ...
            String mostrandoMedicos = "SELECT Nome, Usuario from new_medico WHERE " +
                    UsuarioPlano.getText() + "='true' and Especialidade='UROLOGIA'";
            try{
    ...
    public void validarAgendamento(){
        ...
        String mostrarMed = "SELECT Usuario from new_medico WHERE Nome='" +
                Medicoescolhido.getText() + "' and Especialidade='UROLOGIA' and " + UsuarioPlano.getText() + "='true'";
        ...
        try{
            ...
            String verAgendamento = "SELECT Posicao from new_agendamento WHERE Especialidade='UROLOGIA' and " +
    ...
    public void BotarAgenda(){
        ...
        String novoAgendamento2 = "'" + getMedUsu() + "','" + Usuario.getText() + "','" + getPreco() + "','UROLOGIA','"
