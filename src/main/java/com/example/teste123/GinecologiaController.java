...
public class GinecologiaController {
    ...
    public void initialize(){
        ...
        try{
            ...
            String mostrandoMedicos = "SELECT Nome, Usuario from new_medico WHERE " +
                    UsuarioPlano.getText() + "='true' and Especialidade='GINECOLOGIA'";
            try{
    ...
    public void validarAgendamento(){
        ...
        String mostrarMed = "SELECT Usuario from new_medico WHERE Nome='" +
                Medicoescolhido.getText() + "' and Especialidade='GINECOLOGIA' and " + UsuarioPlano.getText() + "='true'";
        ...
        try{
            ...
            String verAgendamento = "SELECT Posicao from new_agendamento WHERE Especialidade='GINECOLOGIA' and " +
    ...
    public void BotarAgenda(){
        ...
        String novoAgendamento2 = "'" + getMedUsu() + "','" + Usuario.getText() + "','" + getPreco() + "','GINECOLOGIA','"
